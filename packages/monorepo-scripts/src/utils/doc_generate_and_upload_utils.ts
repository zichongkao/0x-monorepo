...
export class DocGenerateAndUploadUtils {
    ...
    public async generateAndUploadDocsAsync(): Promise<void> {
        ...
        const testJsonFilePath = path.join(this._packagePath, 'generated_docs', 'test.json');
        writeFileSync(testJsonFilePath, JSON.stringify(standardizedTypedocOutput, null, 2));
